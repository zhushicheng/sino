  ...
  <div class="usermanage minWidth1000">
    ...
    <div class="sino-queryList">
      <div class="sino-table-total">
        ...
        <sino-table class="data-re-table" :data="serveData" border :row-style="showTr" max-height="416" stripe v-on:viewAll="viewAll">
          <sino-table-column type="index" label="序号" width="60"  fixed="left" align="center"></sino-table-column>
          ...
          <sino-table-column label="产品名称" prop="prodName" min-width="180">
          </sino-table-column>
