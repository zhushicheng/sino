  ...
  <div class="usermanage">
    ...
    <div class="sino-queryList">
      <div class="sino-table-total">
        ...
        <sino-table :data="billData" style="width: 100%" v-on:viewAll="viewAll" border stripe v-on:select="selectCallBack">
          ...
          <sino-table-column :prop="item.colName" :label="item.chName" min-width="150" v-for="(item, index) in tableTitle" :key="index"
                             v-if="!item.isHaveGroupCodt"></sino-table-column>
