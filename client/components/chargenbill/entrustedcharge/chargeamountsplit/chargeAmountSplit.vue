    ...
    <sino-con>
      ...
      <div class="configuration-table-box" >
        ...
        <sino-table :data="tableData" stripe @select="selectTabelRow">
          ...
          <sino-table-column prop="taxpayerTypeDict" label="当前金额" align="right"></sino-table-column>
          <sino-table-column prop="taxPayerNo" label="拆出金额（元）" align="right"></sino-table-column>
          <sino-table-column prop="vatUnitName" label="剩余金额（元）" align="right"></sino-table-column>
        </sino-table>
