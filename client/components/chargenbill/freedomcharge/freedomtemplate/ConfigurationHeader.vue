    ...
    <div class="role-content">
      ...
      <div style="background: #fff;margin-top: 10px">
        <div class="sino-table-icon-left configuration-table-title">
          <sino-button type="text":style="{'margin-left':'21px','padding-top':'5px','width':'150px'}"><!--<i class="iconfont sino-zhangdan-copy"></i>应用到其它模版-->
          </sino-button>  <!--@click="clickFun('','add')" -->
        </div>
        <div class="etyma-content small-etyma-content fl configuration-table" :style="{'margin-right':'3%','padding-left':'20px'}">
          <div>
            ...
            <div class="sino-table-total configuration-table-box">
              <div class="configuration-table-box-child">未配置表头 <span>已选<span :style="{'color':'#399ff2'}">{{checkLenth}}/{{total}}</span>项</span></div>
              <!--<div class="configuration-table-box-childa"><sino-checkbox class="configuration-table-box-checkbox"></sino-checkbox><span>已选<span :style="{'color':'#399ff2'}">{{checkLenth}}/{{total}}</span>项</span></div>-->
        ...
        <div class="etyma-content small-etyma-content fl configuration-table">
            <div class="etyma-content-box" >
              <div class="clear"></div>
              <div class="sino-table-total configuration-table-box" >
                <div class="configuration-table-box-child">已配置表头 已选<span :style="{'color':'#399ff2'}">{{checkLenth2}}/{{total2}}</span>项</div>
                ...
                <sino-table :data="tableDataB" v-on:select="selectCallBack2" @select-all="selectCallback2All" stripe border max-height="416">
                  <sino-table-column  type="selection"></sino-table-column>
                  <sino-table-column  type="index" label="序号" width="50"></sino-table-column>
                  <sino-table-column prop="chName" label="中文名称"></sino-table-column>
                  <sino-table-column prop="enName" label="西文名称"></sino-table-column>
...
//        treeList: [],
    ...
    methods: {
      ...
      change (data) {
        let obj = {
          chargeBillTempHeadId: data.chargeBillTempHeadId,
